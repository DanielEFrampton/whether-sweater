class Api::V1::MunchiesController < ApplicationController
  def show
    ...
    forecast = DarkSkyService.new.simple_future_forecast(end_location[:lat], end_location[:long], distance_info[:arrival_timestamp])
    ...
    munchies = Munchies.new(forecast, restaurant_info, distance_info[:travel_time], end_location[:city_state])
